...
@section('content')
    ...
    <!-- Breadcumb Area -->
    <div class="breadcumb_area" style="background_color:#303030;">
    ...
    <section class="shop_grid_area section_padding_100">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Shop Top Sidebar -->
                    <!-- <div class="shop_top_sidebar_area d-flex flex-wrap align-items-center justify-content-between" style="background-color:#303030">
