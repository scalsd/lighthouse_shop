            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><img src="{{asset('backend/assets/images/left-arrow.png')}}" alt="picture" style="width: 15px; height: 15px; padding-top: 2px"></i></a><span class="admin-panel-title">Добавить книгу</span></h2>
                    </div>            
                </div>
            </div>
                            ...
                            <form action="{{route('book.store')}}" method="post">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="thumbnail" class="form-control" style="background-color: #d4d3ce;" type="text" name="book_cover">
                                        </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <label for="" style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Возрастное ограничение</label>
                                        <select name="age-limit" class="form-control" style="width: 100%; background-color: #d4d3ce">
                                            <option value="">Возраст</option>
                                            <option value="0+" {{ old('age_limit') == '0+' ? 'selected' : '' }}>0+</option>
                                            <option value="6+" {{ old('age_limit') == '0+' ? 'selected' : '' }}>6+</option>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <label for="" style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Год издания</label>
                                        <input type="number" class="form-control" placeholder="Год" name="year" style="background-color: #d4d3ce;" value="{{old('year')}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <label for="" style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Количество страниц</label>
                                        <input type="number" class="form-control" placeholder="Количество страниц" name="amount_pages" style="background-color: #d4d3ce;" value="{{old('amount_pages')}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <label for="" style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Тип переплета</label>
                                        <select name="binding_type" class="form-control" style="width: 100%; background-color: #d4d3ce">
                                            ...
                                            <option value="Мягкий перплет" {{ old('binding_type') == 'Мягкий перплет' ? 'selected' : '' }}>Мягкий перплет</option>
                                            <option value="Твердый переплет" {{ old('binding_type') == 'Твердый переплет' ? 'selected' : '' }}>Твердый переплет</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <label for="" style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Формат</label>
                                        <input type="text" class="form-control" placeholder="Формат" name="format" style="background-color: #d4d3ce;" value="{{old('format')}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <label for="" style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Вес</label>
                                        <input type="number" class="form-control" placeholder="Вес" name="weight" style="background-color: #d4d3ce;" value="{{old('weight')}}">
                                    </div>
                                </div>
                                ...
                                <label for=""style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Описание</label>
                                    <div class="form-group" style="background-color: #d4d3ce;">
                                        <textarea id="description" class="form-control"  placeholder="Напишите текст..." name="description" style="background-color: #d4d3ce;">{{old('description')}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <label for="" style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">ISBN <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" placeholder="ISBN" name="isbn" style="background-color: #d4d3ce;" value="{{old('isbn')}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <label for="" style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Количество <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" placeholder="Количество" name="stock" style="background-color: #d4d3ce;" value="{{old('stock')}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <label for="" style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Цена <span class="text-danger">*</span></label>
                                        <input type="number" step="any"  class="form-control" placeholder="Цена" name="price" style="background-color: #d4d3ce;" value="{{old('price')}}">
                                    </div>
                                </div>
