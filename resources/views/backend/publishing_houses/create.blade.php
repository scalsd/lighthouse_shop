            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><img src="{{asset('backend/assets/images/left-arrow.png')}}" alt="picture" style="width: 15px; height: 15px; padding-top: 2px"></i></a><span class="admin-panel-title">Добавить издательство</span></h2>
                    </div>            
                </div>
            </div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12"  style="background-color:#303030;">
                    <div class="card" style="background-color:#242424;">
                        <div class="body">
                            <form action="{{route('publishing_house.store')}}" method="post">
                                @csrf
                                <div class="row clearfix">
