            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><img src="{{asset('backend/assets/images/left-arrow.png')}}" alt="picture" style="width: 15px; height: 15px; padding-top: 2px"></i></a><span class="admin-panel-title">Редактировать категорию </span></h2>
                    </div>            
                </div>
            </div>
                            ...
                            <form action="{{route('category.update', $category->id)}}" method="post">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <label for="" style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Название <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" placeholder="Название" name="title" style="background-color: #d4d3ce;" value="{{$category->title}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="thumbnail" class="form-control" style="background-color: #d4d3ce;" type="text" name="photo" value="{{$category->photo}}">
                                        </div>
                                ...
                                <label for=""style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Описание</label>
                                    <div class="form-group" style="background-color: #d4d3ce;">
                                        <label for=""style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Описание</label>
                                        <textarea id="description" class="form-control"  placeholder="Напишите текст..." name="description" style="background-color: #d4d3ce;">{{$category->description}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <label for="" style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Статус<span class="text-danger">*</span></label>
                                        <select name="status" class="form-control" style="width: 100%; background-color: #d4d3ce">
                                            ...
                                            <option value="inactive" {{ $category->status == 'inactive' ? 'selected' : '' }}>Неактивный</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <button type="button" class="btn btn-outline-secondary" style="background-color: #986f31; color:#303030;" onclick="window.location.href='{{ route('category.index') }}';">Отменить</button>
                                </div> 
                            </form>                        
                        </div>
                    </div>
