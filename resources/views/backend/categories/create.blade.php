            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><img src="{{asset('backend/assets/images/left-arrow.png')}}" alt="picture" style="width: 15px; height: 15px; padding-top: 2px"></i></a><span class="admin-panel-title">Добавить категорию</span></h2>
                    </div>            
                </div>
            </div>
                            ...
                            <form action="{{route('category.store')}}" method="post">
                                ...
                                <label for=""style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Описание</label>
                                    <div class="form-group" style="background-color: #d4d3ce;">
                                        <textarea id="description" class="form-control"  placeholder="Напишите текст..." name="description" style="background-color: #d4d3ce; color:#242424">{{old('description')}}</textarea>
                                    </div>
                                </div>
