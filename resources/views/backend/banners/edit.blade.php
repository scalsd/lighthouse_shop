                            ...
                            <form action="{{route('banner.update', $banner->id)}}" method="post">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <label for="" style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Название <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" placeholder="Название" name="title" style="background-color: #d4d3ce;" value="{{$banner->title}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="thumbnail" class="form-control" style="background-color: #d4d3ce;" type="text" name="photo" value="{{$banner->photo}}">
                                        </div>
                                ...
                                <label for=""style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Описание</label>
                                    <div class="form-group" style="background-color: #d4d3ce;">
                                        <label for=""style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Описание</label>
                                        <textarea id="description" class="form-control"  placeholder="Напишите текст..." name="description" style="background-color: #d4d3ce;">{{$banner->description}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <label for="" style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Статус<span class="text-danger">*</span></label>
                                        <select name="status" class="form-control" style="width: 100%; background-color: #d4d3ce">
                                            ...
                                            <option value="inactive" {{ $banner->status == 'inactive' ? 'selected' : '' }}>Неактивный</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <button type="button" class="btn btn-outline-secondary" style="background-color: #986f31; color:#303030;" onclick="window.location.href='{{ route('banner.index') }}';">Отменить</button>
                                </div> 
                            </form>                        
                        </div>
                    </div>
