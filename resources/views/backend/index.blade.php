            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><img src="{{asset('backend/assets/images/left-arrow.png')}}" alt="picture" style="width: 10px; height: 10px;"> <span class="admin-panel-title">Административная панель</span></h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html"><img src="{{asset('backend/assets/images/home.png')}}" alt="picture" style="width: 15px; height: 15px;"></a></li>                            
