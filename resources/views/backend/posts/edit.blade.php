            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><img src="{{asset('backend/assets/images/left-arrow.png')}}" alt="picture" style="width: 15px; height: 15px; padding-top: 2px"></i></a><span class="admin-panel-title">Редактировать статью</span></h2>
                    </div>            
                </div>
            </div>
                            ...
                            <form action="{{route('post.update', $post->id)}}" method="post">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <label for="" style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Название <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" placeholder="Название" name="title" style="background-color: #d4d3ce;" value="{{$post->title}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="thumbnail" class="form-control" style="background-color: #d4d3ce;" type="text" name="photo" value="{{$post->photo}}">
                                        </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                <label for=""style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Текст</label>
                                    <div class="form-group" style="background-color: #d4d3ce;">
                                        <label for=""style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Текст</label>
                                        <textarea id="text" class="form-control"  placeholder="Напишите текст..." name="text" style="background-color: #d4d3ce;">{{$post->text}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <label for="" style="font-family: 'Montserrat', sans-serif; font-size: 14px; font-style: normal; color: #d4d3ce; padding-top: 2px;">Статус<span class="text-danger">*</span></label>
                                        <select name="status" class="form-control" style="width: 100%; background-color: #d4d3ce">
                                            ...
                                            <option value="inactive" {{ $post->status == 'inactive' ? 'selected' : '' }}>Неактивный</option>
                                        </select>
                                    </div>
                                </div>
