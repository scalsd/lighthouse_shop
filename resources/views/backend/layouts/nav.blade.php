<nav class="navbar navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-brand">
                <a href="http://lighthouse.local">
                    <img src="{{ asset('backend/assets/images/logo.png') }}" width="60" height="40" alt="logo" class="img-responsive logo">
                </a>
            </div>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a class="dropdown-item icon-menu" href="{{ route('logout') }}"
                                ...
                                <img src="{{asset('backend/assets/images/sign-in.png')}}" alt="picture" style="width: 20px; height: 20px;"> 
                            </a>
